...
function getDefaultModelConfig() {
  return {
    ...
    knowledgeBaseEnabled: valueFromEnv("KNOWLEDGE_BASE_ENABLED", "true") !== "false",
...
function normalizeModelConfig(modelConfig = {}) {
  ...
  return {
    ...
    knowledgeBaseEnabled: merged.knowledgeBaseEnabled !== false && merged.knowledgeBaseEnabled !== 0,
